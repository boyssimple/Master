...
#import "VCAccountOrderDetail.h"
#import "CellAccountDetail.h"
#import "ViewTabAccount.h"
#import "RequestBeanBillDetail.h"
#import "VCAccountDetailContainer.h"
#import "AppDelegate.h"

@interface VCAccountOrderDetail ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation VCAccountOrderDetail
...
- (void)loadData{
    ...
    RequestBeanBillDetail *requestBean = [RequestBeanBillDetail new];
    ...
    [AJNetworkManager requestWithBean:requestBean callBack:^(__kindof AJResponseBeanBase * _Nullable responseBean, AJError * _Nullable err) {
        ...
        if (!err) {
            // 结果处理
            ResponseBeanBillDetail *response = responseBean;
            if(response.success){
                if(self.page == 1){
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    return [CellAccountDetail calHeight];
}

- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    static NSString*identifier = @"CellAccountDetail";
    CellAccountDetail *cell = (CellAccountDetail*)[tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell) {
        cell = [[CellAccountDetail alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
